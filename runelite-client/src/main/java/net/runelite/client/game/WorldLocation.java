...
public enum WorldLocation {
    ...
    PVP_ARENA("PvP Arena", new Location(3338, 3252, 3391, 3204), 0),
    PVP_ARENA_BANK("PvP Arena Bank", new Location(3379, 3274, 3386, 3265), 0),
    PVP_ARENA_PALM_TREES("PvP Arena Palm Trees", new Location(3340, 3280, 3354, 3264), 0),
    PVP_ARENA_TELEPORT("PvP Arena Tele", new Location(3308, 3246, 3326, 3225), 0),
    ...
    static {
        ...
        LOCATION_MAP = (Map<WorldArea, String>)builder.build();
    }
    ...
    public String toString() {
        return "WorldLocation{name='" + this.name + "', worldArea=" + this.worldArea + "}";
    }
}
